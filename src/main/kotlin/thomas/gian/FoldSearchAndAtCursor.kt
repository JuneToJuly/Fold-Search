...
class FoldSearchAndAtCursor : FoldSearchBase() {
    ...
    override fun actionPerformed(event: AnActionEvent) {
        ...
        if(content?.component is FoldSearchHistoryWindow) {
            ...
            val newStringWithAnd = prevSearch?.second + "\n" + cursorText
            ...
            val (action, event) =
                FoldSearchUtil.createFoldSearchAction(searchType, newStringWithAnd, event)
